...
const Regester = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <Helmet>
        <title>Adventure Campus || Register</title>
      </Helmet>
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {errors.conformpass?.type === "minLength" && (
            <span className="text-red-500">
              Password should be at least 6 characters
            </span>
          )}
          {errors.conformpass?.type === "maxLength" && (
            <span className="text-red-500">
              Password should be at most 20 characters
            </span>
          )}
          {errors.conformpass?.type === "pattern" && (
            <span className="text-red-500">
              Password must include uppercase, lowercase, and special character
            </span>
          )}
        ...
        <div className="flex justify-center mt-4">
          <button
            ...
            className="px-20 py-3 bg-[#4285F4] hover:bg-blue-700 text-white p-2 rounded-lg">
            <FaGoogle />
          </button>
        </div>
      </div>

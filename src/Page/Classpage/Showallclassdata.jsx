...
const Showallclassdata = ({ classdata }) => {
  ...
  const { _id, name, img, instructor, price, availableSeats, Enroll } =
    classdata;
  ...
  return (
    <div>
      ...
      <div
        ...
        <figure>
          <img className="h-48 rounded" src={img} alt="Shoes" />
        </figure>
        <div className="card-body">
          ...
          <h2 className=" card-title  opacity-100 p-1 rounded text-center text-gray-400 font-bold text-2xl">
            {name}
          </h2>

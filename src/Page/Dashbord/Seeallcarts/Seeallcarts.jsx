...
const Seeallcarts = () => {
    ...
    return (
      <div className="w-11/12 mt-20 h-full">
        <Helmet>
            ...
            <tbody>
              ...
              {classdatas.map((item, index) => (
                <tr key={item._id}>
                  ...
                  <th>
                    <button
                      onClick={() => handlerApprove(item._id)}
                      className="btn btn-ghost btn-sm bg-red-500 text-white hover:bg-red-600">
                      Approve
                    </button>
                  </th>
                  <th>
                    <button className="btn btn-ghost btn-sm bg-red-500 text-white hover:bg-red-600">
                      Deny
                    </button>
                  </th>
                  <th>
                    <div>
                      <button
                        className="btn btn-ghost btn-sm bg-yellow-500 text-white hover:bg-yellow-600"
                        onClick={openModal}>
                        FeedBack
                      </button>
                      <dialog id="my_modal_1" className="modal">
                        <form
                          ...
                          <div className="modal-action">
                            ...
                            <button className="btn btn-ghost btn-sm bg-yellow-500 text-white hover:bg-yellow-600">
                              Submit
                            </button>
                          </div>
                        </form>

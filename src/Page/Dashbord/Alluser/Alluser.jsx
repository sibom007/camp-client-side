...
const Alluser = () => {
  ...
  return (
    <div className="w-11/12 h-full mt-10">
      <Helmet>
                ...
                <tr key={item._id}>
                  ...
                  <th>
                    {item.role === "admin" ? (
                      ...
                      <button
                        onClick={() => handleradmin(item)}
                        className="btn btn-ghost btn-lg bg-blue-500 text-white hover:bg-blue-600">
                        <FaUser />
                      </button>
                    )}
                  </th>
                  <th>
                    {item.role === "Instructor" ? (
                      ...
                      <button
                        onClick={() => handlerinstoctor(item._id)}
                        className="btn btn-ghost btn-lg bg-yellow-500 text-white hover:bg-yellow-600">
                        <FaUserShield />
                      </button>
                    )}
                  </th>
                  <th>
                    <button
                      ...
                      className="btn btn-ghost btn-lg bg-red-500 text-white hover:bg-red-600">
                      <FaTrash />
                    </button>
                  </th>
                </tr>
